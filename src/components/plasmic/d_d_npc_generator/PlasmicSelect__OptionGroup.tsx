...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: tzRbwH-H9Ix/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: _p3h-q-1811/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__kU9Gj)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__zpi2X)}
              />
            </React.Fragment>
          ),
          value: args.children
